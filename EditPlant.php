...
<div class="split right" style="width:55%; height:4200px; right:45px;">
  <div class="centered">
  <h1>Indoor Plants</h1>
  <?php 
	...
	$sql2 = "SELECT * FROM outdoor";
	$result = mysqli_query($connect, $sql);
	$result2 = mysqli_query($connect, $sql2);
	if ($result->num_rows > 0) {
		$type="Indoor";
		echo "<table border=1><tr>";
		echo "<td>Title</td><td>Price</td><td>Quantity</td><td>Update</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr><td>" . $row["I_title"] . "</td>";
			echo "<td>" . $row["I_price"] ."</td>";
			echo "<td>" . $row["I_quantity"] ."</td>";
			echo "<td><a href='EditPlant2.php?type=".$type."&id=".$row["I_id"]."'><button class='button button4'>Edit Plant</button></a></td></tr>";
		}
		echo"</tr></table>";
	}
	echo "<br><br>";
	echo "<h1>Outdoor Plants</h1>";
	if ($result2->num_rows > 0) {
		$type="Outdoor";
		echo "<table border=1><tr>";
		echo "<td>Title</td><td>Price</td><td>Quantity</td><td>Update</td></tr>";
		while($row = $result2->fetch_assoc()) {
			echo "<tr><td>" . $row["O_title"] . "</td>";
			echo "<td>" . $row["O_price"] ."</td>";
			echo "<td>" . $row["O_quantity"] ."</td>";
			echo "<td><a href='EditPlant2.php?type=".$type."&id=".$row["O_id"]."'><button class='button button4'>Edit Plant</button></a></td></tr>";
		}
		echo"</tr></table>";
	}
	echo "<br><br>";
