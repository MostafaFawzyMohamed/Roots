<?php
	...
	$sqlCart = "SELECT * FROM cartnotlogin WHERE cart_id = '$id'";
	...
	$sql2 = "DELETE FROM `cartnotlogin` WHERE `cart_id`='" . $id . "'";
	
			if(mysqli_query($connect, $sql2)){
				echo "<script>alert('Deleted Successfully !');</script>";
				echo "<script>window.location='CartWithoutLogin.php'</script>";
			}
	else {
