...
<div class="class2" align="center">		
    <form id="" method="post" action="AddT.php" enctype="multipart/form-data">
		...
		<th>
			...
			<td>
			 <a href="home.html"><button class="button button3" style="width:250px;">Add Tool</button></a>
