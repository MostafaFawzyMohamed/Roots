...
?>
		...
		<?php 
			...
			if($row['T_id']==19){
				...
				<img src="<?php echo $row["T_img"] ;?>" style="height:425px; width:350px; border: 1px solid white; background-color:white; padding: 10px;"><br>
				<?php echo $row["T_title"] ?><br><?php echo $row["T_price"] ?> SAR
				<br><?php echo "Units: ".$row["T_quantity"] ?><br>
				<form method="post" action="AddTCart.php">
				<input type="text" name="Product_id" value="<?php echo $row["T_id"] ?>" hidden>
				<input type="text" name="Product_type" value="Tools" hidden>
				...
				<?php 
				$Rating = "SELECT * FROM `rating` WHERE T_ID=".$row["T_id"] ;
				$sumRating=0;
				$i=0;
		...
		?>		
			<form method="post" action="Rating.php">
				...
				<input type="text" name="type" value="<?php echo $type; ?>" hidden>
				<input type="text" name="Product_type" value="<?php echo "Tools"; ?>" hidden>
				<input type="number" name="Product_id" value="<?php echo $row["T_id"]; ?>" hidden>
			...
			<?php }} } ?>
				<?php }
				if(isset($_GET['success'])&&isset($_GET['id'])&&$row["T_id"]==$_GET['id']){
				?>
