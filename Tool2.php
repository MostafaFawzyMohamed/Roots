...
?>
		...
		<?php
			...
			echo "<span onclick='currentt(1, 0)'><img src='". $img . "' style='height:50px; width:50px;'/></span>";
			echo "<span onclick='currentt(2, 0)'><img src='". $row["T_img"] . "' style='height:50px; width:50px;'/></span>";
			echo "</div></div></td>";
		}
		if($row['T_id']==21){
				$img=$row['T_img'];
		...
		<?php
			...
			<?php
			echo "<div style='text-align:center'>";
			echo "<span onclick='currentt(1, 1)'><img src='". $img . "' style='height:50px; width:50px;'/></span>";
			echo "<span onclick='currentt(2, 1)'><img src='". $row["T_img"] . "' style='height:50px; width:50px;'/></span>";
			echo "</div></div></td>";
		}
		if($row['T_id']==23){
				$img=$row['T_img'];
		...
		<?php
			...
			<?php
			echo "<div style='text-align:center'>";
			echo "<span onclick='currentt(1, 2)'><img src='". $img . "' style='height:50px; width:50px;'/></span>";
			echo "<span onclick='currentt(2, 2)'><img src='". $img2 . "' style='height:50px; width:50px;'/></span>";
			echo "<span onclick='currentt(3, 2)'><img src='". $row["T_img"] . "' style='height:50px; width:50px;'/></span>";
			echo "</div></div></td>";
		}	
...
let slideId2 = ["mySlides4", "mySlides5" , "mySlides6" ]
showSlidess(1, 0);
showSlidess(1, 1);
showSlidess(1, 2);

function plusSlides(n, no) {
  showSlidess(slideIndex2[no] += n, no);
}

function currentt(n, no) {
  showSlidess(slideIndex2[no] = n, no);
}

function showSlidess(n, no) {
  let i;
