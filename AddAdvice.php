...
<div class="class2" align="center">		
    <form id="" method="post" action="AdviceAdd.php" enctype="multipart/form-data">

        <table class="rounded-corners" align="center" >
		<th>
			<legend><a href="index.html"><img src="logo.png" align="center" width="20%"></a></legend>
			<center><h1 style="color: #2a453c;">Add Advice</h1>
		</th>
			<tr>
                <td><input type="text" placeholder="Title" name="title" id="title"></td>
            </tr>
			<tr>
                <td><center><input type="text" placeholder="details" name="details" required/></td>
            </tr>
			<td>
			 <button class="button button3" style="width:250px;">Add Advice</button></a>
