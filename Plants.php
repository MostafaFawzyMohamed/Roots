...
<div id="cat">
                    <ul>
						...
						<div class="class1 filter dropdown">
							<li id="Advices" class="filter"><a href="AdvicesAfter.php">Advices</a></li>
						</div>
						<div class="class1 filter dropdown">
					...
					<div align="right">
							<p style="color:white;"><?php echo "Admin";?></p>
...
<div class="split right" style="width:1100px; height:150%; right:25px;">
</div>
<div>
</div>
