...
<div class="split right" style="width:45%; height:3500px; right:45px;">
  <div class="centered">
  <h1>Tools</h1>
  <?php 
	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			echo "<td><a href='EditTool2.php?id=".$row["T_id"]."'><button class='button button4'>Edit Tool</button></a></td></tr>";
		}
		echo"</tr></table>";
	}
	echo "<br><br>";
