...
<div class="class2" align="center">		
    <form id="" method="post" action="AddSer.php" enctype="multipart/form-data">
		...
		<th>
			...
			<td>
			 <a href="home.html"><button class="button button3" style="width:250px;">Add Service</button></a>
