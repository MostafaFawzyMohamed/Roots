...
<div class="split right" style="width:45%; height:1000px; right:60px;">
  <div class="centered">
  <h1>Services</h1>
  <?php 
	...
	if ($result->num_rows > 0) {
		...
		echo "<td>Title</td><td>Price</td><td>Update</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr><td>" . $row["S_title"] . "</td>";
			echo "<td>" . $row["S_price"] ."</td>";
			echo "<td><a href='EditService2.php?id=".$row["S_id"]."'><button class='button button4'>Edit Service</button></a></td></tr>";
		}
		echo"</tr></table>";
	}
	echo "<br><br>";
