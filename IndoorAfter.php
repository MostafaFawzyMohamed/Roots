	...
	<div id="cat2">
		...
		?>
			<div style="text-align:right;">
				...
				<p style="font-size:25px; color:white;">Welcome Admin</p></a>
				<a href="Logout.php"><button class="button button4">Logout</button></a><br>
				...
				?>
						...
						?>
											...
											<div style="background-color:white; width:350px; align:center;">
												...
												?>
															<form method="post" action="Rating.php">
																...
																<input type="text" name="type" value="<?php echo $type; ?>" hidden>
																<input type="text" name="Product_type" value="<?php echo "Indoor"; ?>" hidden>
																<input type="number" name="Product_id" value="<?php echo $row["I_id"]; ?>" hidden>
							...
							<td>
								<center>
									<div style="background-color:white; width:350px; align:center;">
										<img src="<?php echo $row["I_img"] ?>" style="height:425px; width:350px; border: 1px solid white; background-color:white; padding: 10px;"><br><br>
										<?php
