...
<div id="cat2">
                    <ul style="background-color: #DCDCDC;">
						...
						<div class="class1 filter dropdown" >
							<li style="background-color:#2a453c;" id="Services" class="active filter"><a href="ServicesAfter.php" style="color:white;">Services</a></li>
						</div>
						<div class="class1 filter dropdown" >
...
?>
	...
	<center>
		...
		<form method="post" action="ServiceOrder.php">
			<input type="number" name="id" value="<?php echo $row["S_id"]; ?>" hidden>
			<input type="text" name="email" value="<?php echo $e; ?>" hidden>
			<input type="number" name="Cust_id" value="<?php echo $id; ?>" hidden>
			<input type="text" name="status" value="Pending" hidden>
			<input type="submit" class="button button4" name="submit" value="Add Service">
		</form>		
		</a>
		</div>
		<?php } ?>
