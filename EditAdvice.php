...
<div class="split right" style="width:45%; height:1700px; right:60px;">
  <div class="centered">
  <h1>Advices</h1>
  <?php 
	...
	if ($result->num_rows > 0) {
		...
		echo "<td>Title</td><td>details</td><td>Update</td></tr>";
		while($row = $result->fetch_assoc()) {
			echo "<tr><td>" . $row["A_title"] . "</td>";
			echo "<td>" . $row["A_details"] ."</td>";
			echo "<td><a href='EditAdvice2.php?id=".$row["A_id"]."'><button class='button button4'>Edit Advice</button></a></td></tr>";
		}
		echo"</tr></table>";
	}
	echo "<br><br>";
